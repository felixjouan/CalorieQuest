export default class AudioManager {
    ...
    create() {
        ...
        var sound_elevator;
        var sound2;
        sound1 = this.scene.sound.add("musique_1", { loop: true, volume: 0.5 });
        sound2 = this.scene.sound.add("sound3", { loop: true, volume: 0.5 });
        sound_elevator=this.scene.sound.add("ascenseur_sound", { loop: false, volume: 0.5 });
        sound_elevator.play();
    ...
    stopElevatorAndPlayMusic1() {
        ...
        if (this.sound1 && !this.sound1.isPlaying) {
            this.sound1.play(); // Démarre la musique de fond
        }
    }
}